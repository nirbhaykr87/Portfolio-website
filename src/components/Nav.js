      ...
      <nav className={`navbar navbar-expand-lg side stickytop ${isDrawerOpen ? 'open' : ''}`}>
        <div className="container mx-md-5">
          <a className="navbar-brand" href="#">
            <span style={{ color: '#01d293' }}>N</span>irbhay <span style={{ color: '#01d293' }}>K</span>umar
          </a>
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <svg className='svg_items_on_nav ' style={{ color: '#808DAD',marginRight:'12px',marginTop:'-4px'}} stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M946.5 505L534.6 93.4a31.93 31.93 0 0 0-45.2 0L77.5 505c-12 12-18.8 28.3-18.8 45.3 0 35.3 28.7 64 64 64h43.4V908c0 17.7 14.3 32 32 32H448V716h112v224h265.9c17.7 0 32-14.3 32-32V614.3h43.4c17 0 33.3-6.7 45.3-18.8 24.9-25 24.9-65.5-.1-90.5z"></path></svg>
                  <NavLink className="nav-link" aria-current="page" to="/" onClick={closeDrawer}>
                ...
                <svg  className="hide" style={{ color: '#808DAD',marginRight:'12px',marginTop:'-4px'}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
</svg>

                  <NavLink className="nav-link" to="/about" onClick={closeDrawer}>
                    About
                  </NavLink>
                </li>
                <li className="nav-item">
                ...
                <svg
  className='svg_items_on_nav1'
  style={{ fill: '#808DAD', marginRight: '12px', marginTop: '4px' }}
  width="16"  
  height="16" 
...
>
  <path d="M22 0h-20v24h14l6-6v-18zm-6 18h4.36l-4.36 4.385v-4.385zm-3 1h-8v1h8v-1zm0-3h-8v1h8v-1zm6-2v-1h-14v1h14zm-7.059-4.968c-1.147-.265-2.214-.497-1.697-1.473 1.573-2.97.417-4.559-1.244-4.559-1.694 0-2.821 1.65-1.244 4.559.532.982-.575 1.214-1.697 1.473-1.024.237-1.062.745-1.059 1.635l.001.333h7.997l.001-.323c.004-.896-.03-1.407-1.058-1.645zm7.059.968h-4v1h4v-1zm0-2v-1h-4v1h4zm0-4h-4v1h4v-1z" />
                  ...
                  <NavLink className="nav-link" to="/resume" onClick={closeDrawer}>
                    Resume
                  </NavLink>
                </li>
                <li className="nav-item">
